...
const DashBoard = () => {
    ...
    const statDay = [...botInfo.errors, ...botInfo.completed]
                ...
                <div className='box__activity__to__week'>
                    ...
                    <div className='content__activity'>
                        <div className='col__name__item'>
                            <p className='name__item'>{`${new Date(new Date().setDate(new Date().getDate())).toISOString().slice(5, 10)}`}</p>
                            <p className='name__item'>{`${new Date(new Date().setDate(new Date().getDate() - 2)).toISOString().slice(5, 10)}`}</p>
                            <p className='name__item'>{`${new Date(new Date().setDate(new Date().getDate() - 3)).toISOString().slice(5, 10)}`}</p>
                            <p className='name__item'>{`${new Date(new Date().setDate(new Date().getDate() - 4)).toISOString().slice(5, 10)}`}</p>
                            <p className='name__item'>{`${new Date(new Date().setDate(new Date().getDate() - 5)).toISOString().slice(5, 10)}`}</p>
                            <p className='name__item'>{`${new Date(new Date().setDate(new Date().getDate() - 6)).toISOString().slice(5, 10)}`}</p>
                            <p className='name__item'>{`${new Date(new Date().setDate(new Date().getDate() - 7)).toISOString().slice(5, 10)}`}</p>
                        </div>
                        <div className='col__progressbar'>
                            ...
                            <div className='progressbar'>
                                <span style={{ width: `${25}%` }} className='progresbar__item'></span>
                            </div> 
                            <div className='progressbar'>
                                <span style={{ width: `${60}%` }} className='progresbar__item'></span>
                            </div> 
                            <div className='progressbar'>
                                <span style={{ width: `${83}%` }} className='progresbar__item'></span>
                            </div> 
                            <div className='progressbar'>
                                <span style={{ width: `${90}%` }} className='progresbar__item'></span>
                            </div> 
                            <div className='progressbar'>
                                <span style={{ width: `${1}%` }} className='progresbar__item'></span>
                            </div> 
                            <div className='progressbar'>
                                <span style={{ width: `${55}%` }} className='progresbar__item'></span>
                            </div> 
                        </div>
                        <div className='col__procent'>
                            <p className='procent__item'>{`${12}%`}</p>
                            <p className='procent__item'>{`${25}%`}</p>
                            <p className='procent__item'>{`${60}%`}</p>
                            <p className='procent__item'>{`${83}%`}</p>
                            <p className='procent__item'>{`${90}%`}</p>
                            <p className='procent__item'>{`${1}%`}</p>
                            <p className='procent__item'>{`${55}%`}</p>
                        </div>
                    </div>
